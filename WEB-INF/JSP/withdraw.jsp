...
<body>
	...
	<br>
	<center>
		<b><h2>Withdraw your money...</h2></b>
	</center>
	<br>
	<br>
	<div class="container">
		<form action="Bank-Application/app/bank/home/withdrawSuccess" method="post">
			<label for="fname">Account No</label> <input type="text" id="fname"
				name="accountno" title="Please ,enter correct account number">

			<label for="lname">Amount</label> <input type="text" id="lname"
				name="amount"> 
				<br><br>
